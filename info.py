...
URL = "https://dikeebot.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://dikeebot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://dikeebot.onrender.com/".format(FQDN)
else:
    URL = "https://dikeebot.onrender.com/".format(FQDN)
