...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001892817060'))
...
URL = "https://tgbot-5ssr.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tgbot-5ssr.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tgbot-5ssr.onrender.com/".format(FQDN)
else:
    URL = "https://tgbot-5ssr.onrender.com/".format(FQDN)
